...
def test_LeavePage(shared_page):
    ...
    expect(shared_page.get_by_role("button", name="Search")).to_be_visible(timeout=10000)
...
def test_TimePage(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Select Employee")).to_be_visible(timeout=10000)
    print("Verified Select Employee heading is visible on the time page")
    expect(shared_page.locator("form.oxd-form").get_by_role("button", name="View")).to_be_visible(timeout=10000)
...
def test_RecruitmentPage(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Candidates")).to_be_visible(timeout=10000)
...
def test_MyInfoPage(shared_page):
    ...
    expect(shared_page.locator("form.oxd-form").get_by_role("button", name="Save")).to_be_visible(timeout=10000)
...
def test_MaintenancePage(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Administrator Access")).to_be_visible(timeout=10000)
...
def test_ClaimPage(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Employee Claims")).to_be_visible(timeout=10000)
