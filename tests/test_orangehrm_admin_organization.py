...
def test_OrganizationGeneralInformation(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="General Information")).to_be_visible(timeout=10000)
...
def test_OrganizationLocations(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Locations")).to_be_visible(timeout=10000)
...
def test_OrganizationStructure(shared_page):
    ...
    expect(shared_page.get_by_role("heading", name="Organization Structure")).to_be_visible(timeout=10000)
