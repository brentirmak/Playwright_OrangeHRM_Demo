...
def test_PIMPageReportsLoadPIMSampleReport(shared_page):
    ...
    print("Clicked on Report Name field - will enter PIM Sample Report into it")
    pim_page.fill_report_name_field()
    print("Clicked on the Report Name field - will click PIM Sample Report option")
    pim_page.click_pim_sample_report_option()
    print("Clicked on PIM Sample Report option - will click on the Search button")
    pim_page.click_search_button()
    expect(shared_page.get_by_text("(1) Record Found")).to_be_visible()
    ...
    pim_page.click_pim_sample_report_icon()
    print("Clicked on the icon associated with the PIM Sample Report")
    expect(shared_page.get_by_role("heading", name="PIM Sample Report")).to_be_visible()
    print("Verified that the PIM Sample Report header is visible")
    expect(shared_page.get_by_text("Date of Birth")).to_be_visible()
    print("Verified that the Date of Borth column is visible")
    expect(shared_page.get_by_text("American").first).to_be_visible()
    print("Verified that the American text is visible in the table")
